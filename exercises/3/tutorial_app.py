import logging
import os # Retrieves enviroment variabels
import time

from quixstreams import Application
from quixstreams.sources import Source # Custom source rather than kafka

logger = logging.getLogger(__name__) # To get debg messages


SALES_TAX = 1.10


class PurchaseGenerator(Source): # This inherits from Source that the parent, meaning it acts like a Kafka topic but generates fake data.
    """
    What a Source is:
    ...
    def __init__(self):
        super().__init__(name="customer-purchases") # using super calls the parent class - soruce. Customerpurchaces is where data will come from
